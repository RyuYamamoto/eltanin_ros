...
#ifndef ELTANIN_CONTROLLER__DIAGNOSTIC_HPP_
#define ELTANIN_CONTROLLER__DIAGNOSTIC_HPP_

#include <algorithm>
#include <string>
#include <string_view>

namespace eltanin_controller::diagnostic
{

inline constexpr std::string_view PREFIX = "eltanin_controller: ";
...
#endif  // ELTANIN_CONTROLLER__DIAGNOSTIC_HPP_
